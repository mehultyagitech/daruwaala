...
<head>
    ...
    <title>Daruwala || Liquor Solution</title>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-5 col-12">
                            ...
                            <div class="header-search-cart-area">
                                <ul>
                                    ...
                                    <li class="currency-menu"><a href="#"><i class="flaticon-user" onhover="login()"></i></a>
                                        <!--Crunccy dropdown-->
                                        <ul class="currency-dropdown">
                                            ...
                                            <li><a href="#">language</a>
                                                <ul>
                                                    ...
                                                    <li><a href="#"><img src="assets/images/icons/de-de.png" alt="">Hindi</a></li>
                                                </ul>
                                            </li>
                                            ...
                                            <li><a href="my-account.php">My account</a>
                                                <ul>
                                                    <li><a href="login-register.php" onhover="login()">Login</a></li>
                                            ...
                                            <ul class="cart-items">
                                                <li class="single-cart-item">
                                                    ...
                                                    <div class="cart-content">
                                                        <h5 class="product-name"><a href="single-product.php">Balentine</a></h5>
                                                ...
                                                <li class="single-cart-item">
                                                    ...
                                                    <div class="cart-content">
                                                        <h5 class="product-name"><a href="single-product.php">Black Label</a></h5>
                                                        <span class="product-quantity">1 ×</span>
