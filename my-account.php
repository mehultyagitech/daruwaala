                                ...
                                <div class="tab-content" id="myaccountContent">
                                    ...
                                    <div class="tab-pane fade show active" id="dashboad" role="tabpanel">
                                        <div class="myaccount-content">
                                            ...
                                            <div class="welcome mb-20">
                                                <p>Hello, <strong>Mehul Tyagi</strong> (If Not <strong>Mehul !</strong><a href="login-register.php" class="logout"> Logout</a>)</p>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="address-edit" role="tabpanel">
                                        <div class="myaccount-content">
                                            ...
                                            <address>
                                                <p><strong>Mehul Tyagi</strong></p>
                                                <p>College of Engineering Roorkee <br>
                                                Haridwar</p>
                                                    <p>Uttarakhand</p>
                                            </address>
